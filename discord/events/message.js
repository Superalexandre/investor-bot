...
module.exports = class Message {
    ...
    async run(message) {
        ...
        if (mentionned) {
            ...
            return client.logger.commandLog(message, prefix, "mention", messageTime, ((Date.now() - start) / 1000) - messageTime)
        }
        ...
        try {
            ...
            cmd.run({
                ...
                client.logger.commandLog(message, prefix, cmd.help.name, messageTime, ((Date.now() - start) / 1000) - messageTime)
            }).catch(error => {
